...
describe("Create Rental", ()=> {
    ...
    it(" should not be able to create a new rental if there another open to the same user", async()=> {
        ...
        }).rejects.toBeInstanceOf(AppError); //espero que isso de erro, pq usuário ja existe
    });
    ...
    it(" should not be able to create a new rental if there another open to the same car", async()=> {
        ...
        }).rejects.toBeInstanceOf(AppError); //espero que isso de erro, pq o carro ja existe
    });
    ...
    it(" should not be able to create a new rental with invalid return time ", async()=> {
        ...
        }).rejects.toBeInstanceOf(AppError); //deve dar erro se a data de retorno é um horário válido
    });
})